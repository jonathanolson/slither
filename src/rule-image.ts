...
import { squareOnlyImpliedEdgeGeneration2RuleSets, squareOnlyImpliedEdgeGeneration3RuleSets } from './model/pattern/data/rules.ts';
...
( async () => {
  ...
  showRuleSet( squareOnlyImpliedEdgeGeneration3RuleSets[ 0 ] );
