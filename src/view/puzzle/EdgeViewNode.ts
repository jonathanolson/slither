...
export class EdgeViewNode extends Node {
  public constructor(
    ...
    super({
      children: [whitePath, redXPath, redLinePath],
      pickable: false,
    });
    ...
    const multilink = Multilink.multilink(
      ...
      (state, isSolved, whiteLineVisible, redXsVisible, redXsAligned, redLineVisible, redLineStyle) => {
