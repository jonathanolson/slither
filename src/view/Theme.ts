...
export const lightTheme = addThemeLUT({
  ...
  blackLineColorProperty: new PaintColorProperty('rgb(51,51,51)'),
  redLineColorProperty: new PaintColorProperty('rgba(0,0,0,0.47999999999999998224)'),
  whiteLineColorProperty: new PaintColorProperty('rgb(97,97,97)'),
  ...
  faceColorBasicTargetColorProperty: new PaintColorProperty('rgba(237,192,192,0)'),
  faceColorLightTargetColorProperty: new PaintColorProperty('rgba(244,215,215,0)'),
  faceColorDarkTargetColorProperty: new PaintColorProperty('rgba(230,168,168,0)'),
  ...
  uiLinkColorProperty: new PaintColorProperty('rgb(0,98,255)'),
...
export const darkTheme = addThemeLUT({
  ...
  xColorProperty: new PaintColorProperty('rgb(255,0,0)'),
  blackLineColorProperty: new PaintColorProperty('rgb(184,184,184)'),
  redLineColorProperty: new PaintColorProperty('rgba(255,255,255,0.27000000000000001776)'),
  whiteLineColorProperty: new PaintColorProperty('rgb(89,89,89)'),
  ...
  uiLinkColorProperty: new PaintColorProperty('rgb(79,125,232)'),
