...
QUnit.module( 'Generation', () => {
  ...
  const testGeneration = (
    expectedSequence: BinaryRuleSequence,
    boardCount: number
  ) => {
    ...
    QUnit.test( expectedSequence.getName(), assert => {
      ...
      for ( let i = 0; i < boardCount; i++ ) {
        ...
        const expectedCollection = expectedSequence.collection.withPatternBoardFilter( otherBoard => board === otherBoard );
  ...
  testGeneration( BinaryRuleSequence.deserialize( generalEdgeUnrestrictedSequence as SerializedBinaryRuleSequence ), 13 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalColorUnrestrictedSequence as SerializedBinaryRuleSequence ), 12 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalEdgeColorSequence as SerializedBinaryRuleSequence ), 10 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalEdgeColorUnrestrictedSequence as SerializedBinaryRuleSequence ), 12 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalEdgeSectorSequence as SerializedBinaryRuleSequence ), 10 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalEdgeSectorUnrestrictedSequence as SerializedBinaryRuleSequence ), 10 + 10 );
  testGeneration( BinaryRuleSequence.deserialize( generalAllSequence as SerializedBinaryRuleSequence ), 10 + 8 );
  testGeneration( BinaryRuleSequence.deserialize( generalAllUnrestrictedSequence as SerializedBinaryRuleSequence ), 10 + 8 );
  ...
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyEdgeUnrestrictedSequence as SerializedBinaryRuleSequence ), 13 );
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyColorUnrestrictedSequence as SerializedBinaryRuleSequence ), 12 );
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyEdgeColorSequence as SerializedBinaryRuleSequence ), 10 );
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyEdgeColorUnrestrictedSequence as SerializedBinaryRuleSequence ), 12 );
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyEdgeSectorSequence as SerializedBinaryRuleSequence ), 10 );
  testGeneration( BinaryRuleSequence.deserialize( squareOnlyEdgeSectorUnrestrictedSequence as SerializedBinaryRuleSequence ), 10 );
