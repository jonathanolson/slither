...
import { PolygonalBoard, cairoPentagonalTiling, deltoidalTrihexagonalTiling, elongatedTriangularTiling, floretPentagonalTiling, portugalTiling, prismaticPentagonalTiling, rhombilleTiling, smallRhombitrihexagonalTiling, snubSquareTiling, triangularTiling, trihexagonalTiling } from '../../board/core/TiledBoard.ts';
...
import { TPatternBoardDescriptor, deserializePatternBoardDescriptor, serializePatternBoardDescriptor } from './TPatternBoardDescriptor.ts';
import { arePatternBoardsIsomorphic } from './arePatternBoardsIsomorphic.ts';
import { TPlanarPatternMap, deserializePlanarPatternMap, getSingleEdgePlanarPatternMap, getVertexPlanarPatternMap, serializePlanarPatternMap } from './planar-map/TPlanarPatternMap.ts';
