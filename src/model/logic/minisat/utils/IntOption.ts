...
export class IntOption extends Option {
  ...
  public constructor( category: string, name: string, description: string, def: number = 0, range: IntRange = new IntRange( Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ) ) {
