...
export class DoubleOption extends Option {
  ...
  public constructor( category: string, name: string, description: string, def: number = 0, range: DoubleRange = new DoubleRange( Number.MIN_VALUE, false, Number.MAX_VALUE, false ) ) {
  ...
  public help( verbose: boolean ): void {
    Option.eprintf( '  -%-12s = %-8s %c%4.2f .. %4.2f%c (default: %g)\n',
