...
- Current code TODOs
  ...
  - Modes (changes view and edit):
    - Edit modes (row for all of this?):
      - Edge
      - Edge opposite (red-out?)
      - [IF face-color] Face color match, tap one face then other
      - [IF face-color] Face color opposite, tap one face then other
    ...
    - View modes (space-efficient drop-downs? check combobox again):
      ...
      - Vertex State (none / normal / debug-all (advanced))
      - Topological (none / normal) (advanced-all)
    - 
